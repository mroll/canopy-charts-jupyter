...
# -*- coding: utf-8 -*-
#
# canopy_charts documentation build configuration file
#
...
project = 'canopy_charts'
copyright = '2021, Matt Roll'
author = 'Matt Roll'
...
_version_py = os.path.join(repo, 'canopy_charts', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'canopy_chartsdoc'
...
latex_documents = [
    (master_doc, 'canopy_charts.tex', 'canopy_charts Documentation',
     'Matt Roll', 'manual'),
]
